package com.mauriciogoulart.workshopmongodb.config;
...
import com.mauriciogoulart.workshopmongodb.dto.AuthorDTO;
import com.mauriciogoulart.workshopmongodb.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bomdia!", "Acordei feliz hoje!", new AuthorDTO(maria));
